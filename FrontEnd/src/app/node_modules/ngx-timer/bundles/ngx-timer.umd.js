(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-timer', ['exports', '@angular/common', '@angular/core', 'rxjs'], factory) :
    (factory((global['ngx-timer'] = {}),global.ng.common,global.ng.core,global.rxjs));
}(this, (function (exports,common,i0,rxjs) { 'use strict';
    ...
    var CountupTimerComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        CountupTimerComponent.ctorParameters = function () {
            return [
                { type: CountupTimerService }
            ];
        };
        CountupTimerComponent.propDecorators = {
            startTime: [{ type: i0.Input }],
            countUpTimerConfig: [{ type: i0.Input }]
        };
    ...
    var CountdownTimerService = /** @class */ (function () {
        function CountdownTimerService() {
            var _this = this;
            this.onTimerStatusChange = new i0.EventEmitter();
            //Init
            this.timerValue = {
                seconds: '00',
                mins: '00',
    ...
    var CountdownTimerComponent = /** @class */ (function () {
        ...
        CountdownTimerComponent.propDecorators = {
            startTime: [{ type: i0.Input }],
            countDownTimerConfig: [{ type: i0.Input }]
        };
    ...
    var StopWatchService = /** @class */ (function () {
        function StopWatchService() {
            ...
            this.interval = rxjs.interval(10000);
        }
    ...
    var StopWatchComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        StopWatchComponent.ctorParameters = function () {
            return [
    ...
    exports.NgxTimerModule = NgxTimerModule;
    exports.CountupTimerComponent = CountupTimerComponent;
    exports.CountupTimerService = CountupTimerService;
    exports.countUpTimerConfigModel = countUpTimerConfigModel;
    exports.timerTexts = timerTexts;
    exports.CountdownTimerComponent = CountdownTimerComponent;
    exports.CountdownTimerService = CountdownTimerService;
    exports.countDownTimerConfigModel = countDownTimerConfigModel;
    exports.countDownTimerTexts = countDownTimerTexts;
    exports.TimerStaus = TimerStaus;
    exports.ɵa = StopWatchComponent;
    exports.ɵb = StopWatchService;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=ngx-timer.umd.js.map
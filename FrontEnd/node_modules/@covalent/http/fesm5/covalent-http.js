import { Injectable, Injector, ɵReflectionCapabilities, InjectFlags, Optional, SkipSelf, Self, Inject, inject, INJECTOR, NgModule, InjectionToken, defineInjectable } from '@angular/core';
...
function mixinHttp(base, config, httpInject) {
    ...
    HttpInternalClass = /** @class */ (function (_super) {
        ...
        function HttpInternalClass() {
            ...
            var _this = _super.apply(this, __spread((args && args.length ? args : injectArgs(new ɵReflectionCapabilities().parameters(base), getInjector())))) || this;
...
function TdHttpClient(config) {
    return function (constructor) {
        return /** @class */ (function (_super) {
            ...
            return class_2;
        }(mixinHttp(constructor, config, HttpClient)));
    };
}
